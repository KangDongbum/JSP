...
public class FileController extends HttpServlet {
	 ...
	 * @throws IOException
	 */
	private void downloadController(HttpServletRequest request, HttpServletResponse response, int idx) 
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void deleteController(HttpServletRequest request, HttpServletResponse response, int idx) 
			throws ServletException, IOException {
