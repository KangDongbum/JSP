...
import org.apache.commons.fileupload.disk.*; // DistFileItemFactory
...
public class FileUpload {
	 ...
	 * @param request
	 */
	public FileUpload upload(HttpServletRequest req) {
		try {
			
			String uploadPath = req.getServletContext().getRealPath(File.separator + "resources" + File.separator + "upload");
