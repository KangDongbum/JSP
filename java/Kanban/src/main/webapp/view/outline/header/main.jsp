...
<html>
	<head>
		...
		<script type="text/babel" src="${rootURL}/resources/js/layser.js${version}"></script>
		<script type="text/babel" src="${rootURL}/resources/js/common.js${version}"></script>
		<c:forEach var="script" items="${accScripts}">
			<script type="text/bable" src="${rootURL}/resources/js/${script}.js${version}"></script>
		</c:forEach>
